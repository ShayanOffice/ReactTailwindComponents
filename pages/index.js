    ...
    <div className='py-0 px-8'>
      ...
      <main className='min-h-screen py-16 px-0 flex-1 flex flex-col justify-around items-center'>
        <h1 className='m-0 text-[6rem] text-center flex flex-col justify-center items-center cursor-default'>
          ...
          <span className='text-[#5570f3] text-4xl leading-5 border-b-4 w-full shadow-xl hover:shadow-sm transition-all duration-500 py-5'>
            Components
          </span>
          {/* <p className='text-center my-4 mx-0 leading-6 text-[1.15rem]'>
            Take a look inside:
          </p> */}
        </h1>
        ...
        <div className='flex justify-center items-center flex-wrap min-w-[800px] '>
          <a
            href='/Grid'
            className='m-4 p-6 text-left text-inherit no-underline border-[1px] border-[#5570f329] rounded-[10px] ease-in-out max-w-[300px] hover:text-[#5570f3] hover:border-[#5570f333] shadow-2xl hover:shadow-md transition-all duration-500 relative border-b-4'
          >
